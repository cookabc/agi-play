    ...
    return (
        <>
            <VStack my={4}>
                ...
                <Box my={4} id="video-frame" className={styles.videoFrame}
                     display={moteCam.isReady ? 'block' : 'none'}>
                ...
                <Button my={4} mx='auto' size='lg' w='80%' colorScheme='blue'
                        onClick={moteCam.startAndStop}>{moteCam.isStarted ? "Stop" : "Start"}</Button>
