export default class Pacman {
    ...
    reset() {
        ...
        this.pacmanArrow.style.backgroundImage = 'url(./graphics/'
    ...
    setSpriteSheet(direction) {
        this.animationTarget.style.backgroundImage = 'url(./graphics/'
    ...
    prepDeathAnimation() {
        ...
        this.animationTarget.style.backgroundImage = 'url(./images/'
