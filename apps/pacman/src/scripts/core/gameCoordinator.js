...
export default class GameCoordinator {
     ...
     */
    startButtonClick() {
        this.leftCover.style.left = "-80%";
        this.rightCover.style.right = "-80%";
    ...
    preloadAssets() {
        return new Promise((resolve) => {
            ...
            const imgBase = "./graphics/spriteSheets/";
            const imgSources = [
                // Pacman
    ...
    updateExtraLivesDisplay() {
        ...
        for (let i = 0; i < this.lives; i += 1) {
            ...
            extraLifePic.setAttribute("src", "./graphics/extra_life.svg");
    ...
    advanceLevel() {
        ...
        const imgBase = "./graphics/spriteSheets/maze/";
    ...
    displayText(position, amount, duration, width, height) {
        ...
        pointsDiv.style.backgroundImage = "url(./graphics/" + `spriteSheets/text/${amount}.svg`;
